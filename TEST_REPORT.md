# TEST REPORT — 7th Wonder
> Tester: Senior Engg | Segment: Bakery | Tier-3
...
- Maps URL + JSON-LD Bakery schema + H1 with business name
- No lorem ipsum, no invented hours/prices/ratings

## Build result (2026-09-15)
- [x] `npm run build` PASS (vite 5.4.21, 0 warnings)
- dist: index 13.44 kB / CSS 11.71 kB / JS 1.17 kB — under perf budget (<200KB JS, <1.5MB total)
