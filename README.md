# 7th Wonder — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-7th-wonder/
- **Repo:** `shreekantha3/sindagi-7th-wonder` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-7th-wonder/'` for GitHub Pages project-site hosting.
